...
) : starrail.BattleRelic
{
    ...
    relic.subAffixList.push(protocol.RelicAffix{ .affix_id = stat1, .cnt = cnt1, .step = 3 });
    relic.subAffixList.push(protocol.RelicAffix{ .affix_id = stat2, .cnt = cnt2, .step = 3 });
    relic.subAffixList.push(protocol.RelicAffix{ .affix_id = stat3, .cnt = cnt3, .step = 3 });
    relic.subAffixList.push(protocol.RelicAffix{ .affix_id = stat4, .cnt = cnt4, .step = 3 });
    return relic
}