    ...
    for (let i = 0; i < jsonData.avatar_config.length; i++) {
        ...
        for (let j = 0; j < jsonData.avatar_config[i].relics.length; j++) {
            const tmpRelic = relicCoder(
                jsonData.avatar_config[i].relics.id, 
                jsonData.avatar_config[i].relics.level, 
                jsonData.avatar_config[i].relics.main_affix_id, 
                jsonData.avatar_config[i].relics.stat1, 
                jsonData.avatar_config[i].relics.cnt1, 
                jsonData.avatar_config[i].relics.stat2, 
                jsonData.avatar_config[i].relics.cnt2, 
                jsonData.avatar_config[i].relics.stat3, 
                jsonData.avatar_config[i].relics.cnt3, 
                jsonData.avatar_config[i].relics.stat4, 
                jsonData.avatar_config[i].relics.cnt4
            )
        }
    }
