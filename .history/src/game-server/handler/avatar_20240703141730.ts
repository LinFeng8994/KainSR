...
export async function onGetAvatarDataCsReq(
    ...
    for (const avatarConf of jsonData.avatar_config) {
        ...
        if (multiPath.includes(avatarConf.id)) {
            ...
            switch (avatarConf.id) {
                case 8001:
                    avatarType = BoyWarriorType
                case 8002:
                    avatarType = GirlWarriorType
                case 8003:
                    avatarType = BoyKnightType
                case 8004:
                    avatarType = GirlKnightType
                case 8005:
                    avatarType =BoyShamanType
                case 8006:
                    avatarType = starrail.MultiPathAvatarType.GirlShamanType;
                case 1224: 
                    avatarType = Mar_7thRogueType;
                case 1001: 
                    avatarType = Mar_7thKnightType;
                default:
