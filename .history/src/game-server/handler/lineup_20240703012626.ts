...
export async function onReplaceLineupCsReq(
    ...
    const proto2 : starrail.SyncLineupNotify = new starrail.SyncLineupNotify()
    const bufferData1 = starrail.SyncLineupNotify.encode(proto2).finish()
    await player.send(CmdID.CmdSyncLineupNotify, bufferData2);
}