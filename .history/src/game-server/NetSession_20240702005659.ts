...
export class NetSession {
    ...
    constructor(socketClient: Socket) {
        ...
        this.HandlerList = [
            ...
            { cmdID: CmdID.CmdGetCurLineupDataCsReq, action: onGetCurLineupDataScRsp },
    ...
    private async onMessage(cmd_type: number, payload: Uint8Array): Promise<void> {
        ...
        if (handlerFind) {
            ...
            if (this.TypeList[cmd_type]) {
                ...
                await handlerFind.action(dataReq, this, null);
            }
            else {
                await handlerFind.action({}, this, null);
            }
        }
