...
export class NetSession {
    ...
    private async onMessage(cmd_type: number, payload: Uint8Array): Promise<void> {
        ...
        // const dataDecode = this.dataService.decodeBufferToMessage(this.inputList[command.cmd_type], payload);
        // if (cmd_type !== 1407) {

        // }
        // await command.fun({}, this.dataService, this)
        const dataDecode = this.inputList[cmd_type].decode(payload);
        await command.fun(dataDecode, this.dataService, this)
        return
    }
