...
export class NetSession {
    ...
    constructor(socketClient: Socket) {
        ...
        this.HandlerList = [
            { cmdID: CmdID.CmdPlayerGetTokenCsReq, action: login.onPlayerGetToken },
            { cmdID: CmdID.CmdPlayerLoginCsReq, action: login.onPlayerLogin },
            { cmdID: CmdID.CmdPlayerHeartBeatCsReq, action: misc.onPlayerHeartBeat },
            { cmdID: CmdID.CmdGetAvatarDataCsReq, action: avatar.onGetAvatarData },
            { cmdID: CmdID.CmdGetMultiPathAvatarInfoCsReq, action: avatar.onGetMultiPathAvatarInfo },
            { cmdID: CmdID.CmdGetMissionStatusCsReq, action: mission.onGetMissionStatus },
            { cmdID: CmdID.CmdGetCurLineupDataCsReq, action: lineup.onGetCurLineupData },
            { cmdID: CmdID.CmdGetCurSceneInfoCsReq, action: scene.onGetCurSceneInfo },
            { cmdID: CmdID.CmdSceneEntityMoveCsReq, action: scene.onSceneEntityMove },
            { cmdID: CmdID.CmdStartCocoonStageCsReq, action: battle.onStartCocoonStage },
            { cmdID: CmdID.CmdPVEBattleResultCsReq, action: battle.onPVEBattleResult }
