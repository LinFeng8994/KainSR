...
const targetMessages = messages.filter(message => {
    const boolField = message.fields.find(field => field.type === 'repeated' && field.index === 8);
    const boolField1 = message.fields.find(field => field.type === 'repeated' && field.index === 11);
    const boolField2= message.fields.find(field => field.type === 'repeated' && field.index === 6);
