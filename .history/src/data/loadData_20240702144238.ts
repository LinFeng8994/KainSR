...
export class MainCharacter {
    ...
    getType(): starrail.MultiPathAvatarType {
        switch (this.value) {
            case MainCharacter.MalePhysical:
                return starrail.MultiPathAvatarType.BoyWarrior;
            case MainCharacter.FemalePhysical:
                return starrail.MultiPathAvatarType.GirlWarrior;
            case MainCharacter.MalePreservation:
                return starrail.MultiPathAvatarType.BoyKnight;
            case MainCharacter.FemalePreservation:
                return starrail.MultiPathAvatarType.GirlKnight;
            case MainCharacter.MaleHarmony:
                return starrail.MultiPathAvatarType.BoyShaman;
            case MainCharacter.FemaleHarmony:
                return starrail.MultiPathAvatarType.;
            default:
                return starrail.MultiPathAvatarType.GirlShaman;
        }
    }
