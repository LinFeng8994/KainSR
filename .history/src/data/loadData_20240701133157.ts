...
export class MainCharacter {
    ...
    getType(): starrail.HeroBasicType {
        switch (this.value) {
            case MainCharacter.MalePhysical:
                return starrail.HeroBasicType.BoyWarrior;
            case MainCharacter.FemalePhysical:
                return starrail.HeroBasicType.GirlWarrior;
            case MainCharacter.MalePreservation:
                return starrail.HeroBasicType.BoyKnight;
            case MainCharacter.FemalePreservation:
                return starrail.HeroBasicType.GirlKnight;
            case MainCharacter.MaleHarmony:
                return starrail.HeroBasicType.BoyShaman;
            case MainCharacter.FemaleHarmony:
                return starrail.HeroBasicType.GirlShaman;
            default:
                return starrail.HeroBasicType.GirlShaman;
        }
    }
